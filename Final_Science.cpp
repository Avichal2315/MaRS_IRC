...
// or for rotation of 5 degree  67 (approx) steeps
int step=134;
int STEP = 67;
...
LA linear_actuator(PB5, PB4); // M2(MRW1)  PB5-DIR,  PB4- PWM
...
void loop()
{
  ...
  switch(choice)
  {
    ...
    // Motor1 connected to Linear Actuator (TOP MOTOR)
    case 3:  // up
      Serial.println("pwm:");
      while (Serial.available() == 0);
      pwm = Serial.parseInt();
    ...
    //   servo1.rotate(); break;
    case 9:
      stepper1.CW1(); break; // rotate with 5 degree
   
    case 10:
       stepper1.ACW1(); break; // rotate with 5 degree




    default:
       linear_actuator.stop(); motor1.stop(); motor2.stop(); stepper1.stop();
       break;
  }
}
